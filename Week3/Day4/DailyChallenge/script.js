...
let cinema = 'The movie is not that bad, I like it'
let wordNot = cinema.indexOf('not')
let wordBad = cinema.indexOf('bad')

if (wordBad > wordNot && wordNot > -1){
    let result = `${cinema.slice(0, wordNot)}good${cinema.slice(wordBad + 3)}`
    console.log(result)
}
else {
    console.log(cinema)
